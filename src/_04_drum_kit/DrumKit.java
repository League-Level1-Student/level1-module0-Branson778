...
JPanel panel = new JPanel();
		// 6. Add the panel to therame. (The panel is invisible.)
frame.add(panel);
...
String imgfile = "drum.jpg";
String imgfile2 = "cymbal.jpg";
		// 9. Edit the next line to use your String variable
		 drumLabelWithImage = createLabelImage(imgfile);
		 snareimg = createLabelImage(imgfile2);
...
snareimg.addMouseListener(this);
...
//no need they already have a .wav file
